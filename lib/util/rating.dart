...
class MRatingBar extends StatefulWidget {
  ...
  @override
  _MRatingBarState createState() => _MRatingBarState();
}

class _MRatingBarState extends State<MRatingBar> {
  double _rating = 0.0;
  bool _isRTL = false;
  ...
  @override
  void didUpdateWidget(MRatingBar oldWidget) {
