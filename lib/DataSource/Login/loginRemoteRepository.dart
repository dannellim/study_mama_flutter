...
class LoginRemoteRepository implements LoginDataSource {
  ...
  Future<Response> otpQRString(Map<String, dynamic> data) async {
    Response response = await _loginApiProvider.otpQRString(data);
    return response;
  }
  Future<Response> verifyOTP(Map<String, dynamic> data) async {
    Response response = await _loginApiProvider.verifyOTP(data);
    return response;
  }
}
